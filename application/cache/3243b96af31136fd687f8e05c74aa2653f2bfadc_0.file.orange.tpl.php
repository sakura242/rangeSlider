<?php
/* Smarty version 3.1.29, created on 2019-05-26 20:52:55
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/massage/orange.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5cea7e17350264_42991201',
  'file_dependency' => 
  array (
    '3243b96af31136fd687f8e05c74aa2653f2bfadc' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/massage/orange.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5cea7e17350264_42991201 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
search/massage/">マッサージ検索</a></li>
		<li>お店情報（Oranges Massage）</li>
	</ul>
</nav>
<div id="contents"><!-- CONTENTS -->
<div class="mc">
	<article class="page">
		<h1>お店情報（Oranges Massage）</h1>
		<div class="mcBox mcb">
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>Oranges Massage<small>オレンジマッサージ</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/massage/massage_main_orange.png" alt="Oranges Massage" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											「Oranges Massage」では、20代中ごろの非常に元気で可愛い嬢が30名弱在籍しています。
											そしてほとんどのマッサージ嬢がアルバイトやOLといった素人の女の子が多く在籍しておりますが、マッサージの腕前も雰囲気づくりも一級品！
											また、お風呂ルームは日本式の檜風呂をウリにしており、利用したお客様のほとんどがリピーターになっています。
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>オレンジマッサージ（Oranges Massage）</td>
														</tr>
														<tr>
															<th>地域</th><td>その他</td>
														</tr>
														...
														<tr>
															<th>住所</th><td>3/19 Sukhumvit 31, Klongton, Klongtoey, Bangkok,10110</td>
														</tr>
														<tr>
															<th>連絡先</th><td>02-261-2038</td>
														</tr>
														<tr>
...
img/shop/credit_mc.png" alt="MC" width="45" height="27">
														...
														<tr>
															...
															<td class="menuBox">
																<dl>
																	<dt>シャワールーム</dt>
																	<dd>45分：800バーツ　60分：900バーツ　90分：1,100バーツ　120分：2,500バーツ</dd>
																</dl>
																<dl>
																	<dt>バス/お風呂ルーム</dt>
																	<dd>60分：2,300バーツ　90分：2,500バーツ　120分：2,700バーツ</dd>
																</dl>
															</td>
														</tr>
													</tbody>
...
img/shop/girl/girl_img208.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img209.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img210.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img211.jpg" alt="" width="150" height="200"></li>
											</ul>
											<ul class="pt15">
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img212.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img213.jpg" alt="" width="150" height="200"></li>
											</ul>
										</div>
									</div>
								</section>
							...
							<div class="content">
								<section>
									...
									<div class="subBox">
										<div class="mapBorder">
											<div id="maps">
												<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15502.940792860385!2d100.5660286!3d13.7344753!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xf62da51b39849bb!2sOranges+Massage!5e0!3m2!1sja!2sjp!4v1450666274898" width="642" height="450" frameborder="0"></iframe>
											</div>
										</div>
									</div>
								</section>
