<?php
/* Smarty version 3.1.29, created on 2019-05-24 14:02:09
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/gogo/pink.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce77ad138cf81_48553239',
  'file_dependency' => 
  array (
    '635e4a1ec7323d62b8f0def094a289e7b6f0d014' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/gogo/pink.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce77ad138cf81_48553239 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
search/">お店検索</a></li>
		<li><a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
search/gogo/">カラオケ検索</a></li>
		<li>お店情報（The Pink Panther）</li>
	</ul>
</nav>
<div id="contents"><!-- CONTENTS -->
<div class="mc">
	<article class="page">
		<h1>お店情報（The Pink Panther）</h1>
		<div class="mcBox mcb">
			<div class="inBox font">
				<p><b>このページはただいま準備中です。もうしばらくお待ちください。</b></p>
				<dl>
					<dt>エリア：</dt>
					<dd><strong>パッポン</strong></dd>
				</dl>
				<div class="subBox">
					<ul class="shopTab">
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>The Pink Panther<small>ピンクパンサー</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/gogo/gogo_main_pink.png" alt="The Pink Panther" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											パッポン2通りをスリウォン通りから入る入り口あたり。真ん中だけでなくあちこちにステージがあって、どこに座ってもダンサーが近くに見えるようになっています。
											この店の特徴はゴーゴーバーでありながら、深夜にムエタイやプロレスのショーを開催しているので興味がある方はぜひ！
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>ピンクパンサー（The Pink Panther）</td>
														</tr>
														<tr>
															<th>地域</th><td>パッポン</td>
														</tr>
														...
														<tr>
															<th>住所</th><td>37/4 Patpong Soi2, Suriwongse Rd., Bangrak, Bangkok 10500</td>
														</tr>
														<tr>
															<th>連絡先</th><td>－</td>
														</tr>
														...
														<tr>
															<th>定休日</th><td>禁酒日(仏教の日、王室関係の日、選挙投票日)</td>
														</tr>
														<tr>
															<th>アクセス</th><td>BTSサラデーン駅 MRTシーロム駅徒歩10分</td>
														</tr>
														<tr>
															<th>取扱いカード</th>
															<td>
...
img/shop/girl/girl_img29.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img30.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img138.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img32.jpg" alt="" width="150" height="200"></li>
											</ul>
										</div>
									</div>
								</section>
							...
							<div class="content">
								<section>
									...
									<div class="subBox">
										<div class="mapBorder">
											<div id="maps">
												<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d968.9526867091932!2d100.531803!3d13.729905!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0xa00f26b02a478ce4!2sPink+Panther+Pub!5e0!3m2!1sja!2sus!4v1436773026939" width="642" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
											</div>
										</div>
									</div>
								</section>
