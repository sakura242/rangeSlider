<?php
/* Smarty version 3.1.29, created on 2019-07-18 01:35:26
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/gogo/kings.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5d2f4e4ea34135_13488432',
  'file_dependency' => 
  array (
    '2c15b0fb0febcfe7aa4dc6e7e0c34c9b4b6e9f59' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/gogo/kings.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5d2f4e4ea34135_13488432 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/gogo/gogo_main_kings.png" alt="Kings' Corner"></div>
												<div class="bg"><h2>Kings' Corner<small>キングス・コーナー</small></h2></div>
											</div>
											<div class="inBox font">
												<p>
													パッポン１中程の「スーパープッシー」横。パッポンのゴーゴーバーの重鎮キングスグループの一つ。オカマが多いと言われているようだが、実態は不明。
													しかし、女の子（男の子？）のビジュアルは全ゴーゴーバーの中でも屈指で派手目な子が多い印象。かわいければレディーボーイでもいいという猛者にはオススメの店です。
												</p>
											</div>
											<section>
												<h3>設備／こだわり情報</h3>
												...
												<div class="subBox">
													<div class="tableBox">
														<table>
															<tbody>
																<tr>
																	<th>店舗名</th><td>キングス・コーナー（Kings' Corner）</td>
																</tr>
																<tr>
																	<th>地域</th><td>パッポン</td>
																</tr>
																...
																<tr>
																	...
																	<td class="menuBox">
																		<dl>
																			<dt>ドリンク</dt>
																			<dd>
																				ビール（Singha/Heineken）：150バーツ<br>
																				ソフトドリンク（コーラ/ソーダ/水/氷）：100バーツ<br>
																				レディードリンク：140バーツ
																			</dd>
																		</dl>
																	</td>
...
img/shop/girl/girl_img25.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img26.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img27.jpg" alt="" class="img-width-100"></li>
													</ul>
													<ul>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img28.jpg" alt="" class="img-width-100"></li>
													</ul>
												</div>
											</div>
										</section>
									...
									<div class="content">
										<section>
											...
											<div class="subBox">
												<div class="mapBorder">
													<div id="maps">
														<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d407.3958546267332!2d100.53173533171856!3d13.729079406019071!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0x76ee09a8154516f9!2sKing&#39;s+Corner!5e0!3m2!1sja!2sus!4v1436772957597" width="90%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
													</div>
												</div>
											</div>
										</section>
