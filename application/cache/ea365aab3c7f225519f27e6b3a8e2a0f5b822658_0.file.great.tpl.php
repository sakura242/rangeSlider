<?php
/* Smarty version 3.1.29, created on 2019-05-21 18:40:59
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/massage/great.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce3c7ab8ee4d0_49630276',
  'file_dependency' => 
  array (
    'ea365aab3c7f225519f27e6b3a8e2a0f5b822658' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/massage/great.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce3c7ab8ee4d0_49630276 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
search/massage/">マッサージ検索</a></li>
		<li>お店情報（The Great）</li>
	</ul>
</nav>
<div id="contents"><!-- CONTENTS -->
<div class="mc">
	<article class="page">
		<h1>お店情報（The Great）</h1>
		<div class="mcBox mcb">
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>The Great<small>グレート</h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/massage/massage_main_great.png" alt="The Great" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											「The Great」ですが、ジャンル的にはメンズスパとなります。ちなみにメンズスパとは主に手コキがメインのお店です。
											サービスが複雑ではない分手軽にできるため、女の子の間でも流行っているようで、女の子のレベルが非常に高いです！もちろん腕前は一級品！
											コストパフォーマンスも高いので是非お試しあれ♪
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>グレート（The Great）</td>
														</tr>
														<tr>
															<th>地域</th><td>その他</td>
														</tr>
														...
														<tr>
															<th>住所</th><td>278/36 Soi Lert Keaw2,Asok-Dindaeng Road, Bangkok,10110</td>
														</tr>
														<tr>
															<th>連絡先</th><td>02-245-4755</td>
														</tr>
														<tr>
															<th>営業時間</th><td>12:00～26:00</td>
														</tr>
														<tr>
															<th>定休日</th><td>無休</td>
														</tr>
														<tr>
															<th>アクセス</th><td>MRTラマ9世駅より徒歩約10分</td>
														</tr>
														<tr>
															<th>取扱いカード</th>
															<td>VISA、MASTER
...
img/shop/credit_mc.png" alt="MC" width="45" height="27">
														...
														<tr>
															...
															<td class="menuBox">
																<dl>
																	<dt>オイルマッサージ+フルヌード（ハンドジョブ付き）</dt>
																	<dd>60分：1,500バーツ</dd>
																</dl>
																<dl>
																	<dt>オイルマッサージ+Body to Body（ハンドジョブまたはリップサービス合計2回付き）</dt>
																	<dd>80分：2,000バーツ</dd>
																</dl>
															</td>
														</tr>
							...
							<div class="content">
								<section>
									...
									<div class="subBox">
										<div class="mapBorder">
											<div id="maps">
												<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d31006.480156954352!2d100.56935900000002!3d13.729949!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDQzJzQ3LjgiTiAxMDDCsDM0JzA5LjciRQ!5e0!3m2!1sen!2sus!4v1452244037399" width="642" height="450" frameborder="0"></iframe>
											</div>
										</div>
									</div>
								</section>
