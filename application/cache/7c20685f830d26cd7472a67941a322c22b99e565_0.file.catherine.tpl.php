<?php
/* Smarty version 3.1.29, created on 2019-05-23 07:55:00
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/mp/catherine.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce5d344921888_66004439',
  'file_dependency' => 
  array (
    '7c20685f830d26cd7472a67941a322c22b99e565' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/mp/catherine.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce5d344921888_66004439 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
search/mp/">マッサージパーラー検索</a></li>
		<li>お店情報（Catherine）</li>
	</ul>
</nav>
<div id="contents"><!-- CONTENTS -->
<div class="mc">
	<article class="page">
		<h1>お店情報（Catherine）</h1>
		<div class="mcBox mcb">
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>Catherine<small>キャサリン</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/mp/mp_main_catherine.png" alt="Catherine" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											外観をみると一見古臭さを感じるかもしれませんが、ご安心ください！
											キャサリンはペッブリーにあるラ・デファンスのオーナーが経営する店だけあって女の子の質はGood！
											しかもスタイルの良いキレイ系の女の子が多く在籍していて、ラ・デファンスの在籍キャストとはスタイルを変えています。
											値段もそこそこ安く、平日の夕方でも40人弱位は出勤しているので、女の子の選択には困らないと思います。
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>キャサリン（Catherine）</td>
														</tr>
														<tr>
														...
														<tr>
															<th>住所</th><td>341 Rama 9 Rd, Bangkapi, Huaykwang, Bangkok 10310</td>
														</tr>
														<tr>
															<th>連絡先</th><td>02-719-6672</td>
														</tr>
														<tr>
