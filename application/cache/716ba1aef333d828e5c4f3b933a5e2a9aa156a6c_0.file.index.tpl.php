<?php
/* Smarty version 3.1.29, created on 2020-09-14 04:09:56
  from "D:\xampp\htdocs\taiseisha0911\application\views\pc\index.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5f5ed0f4f345e0_36774341',
  'file_dependency' => 
  array (
    '716ba1aef333d828e5c4f3b933a5e2a9aa156a6c' => 
    array (
      0 => 'D:\\xampp\\htdocs\\taiseisha0911\\application\\views\\pc\\index.tpl',
      1 => 1599820105,
      2 => 'file',
    ),
  ),
...
function content_5f5ed0f4f345e0_36774341 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
            ...
            <ol class="list list-flex">
              <li class="list_item list_item-spaceS list_item-solution">
                <div class="listSolution_item_title">
                  <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/check.png" alt="">
                  <p class="listSolution_item_title_design1">お悩み<span>1</span>
                  </p>
                  <p class="listSolution_item_title_design2">デザイン制作</p>
                </div>
              ...
              <li class="list_item list_item-spaceS list_item-solution">
                <div class="listSolution_item_title">
                  <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/check.png" alt="">
                  <p class="listSolution_item_title_design1">お悩み<span>2</span>
                  </p>
                  <p class="listSolution_item_title_design2">システム開発</p>
                </div>
                <div class="listSolution_item_textBox">
                  <p>新規にシステムを開発したい!</p>
                  <p>今あるシステムを改修したい!!</p>
              ...
              <li class="list_item list_item-spaceS list_item-solution">
                <div class="listSolution_item_title">
                  <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/check.png" alt="">
                  <p class="listSolution_item_title_design1">お悩み<span>3</span>
                  </p>
                  <p class="listSolution_item_title_design2">印刷事業</p>
                </div>
                <div class="listSolution_item_textBox">
                  <p>デザインから印刷まで</p>
                  <p>一貫で引き受けて欲しい！</p>
              ...
              <li class="list_item list_item-spaceS list_item-solution">
                <div class="listSolution_item_title">
                  <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/check.png" alt="">
                  <p class="listSolution_item_title_design1">お悩み<span>4</span>
                  </p>
                  <p class="listSolution_item_title_design2">営業代行業務</p>
                </div>
                <div class="listSolution_item_textBox">
                  <p>営業マンが足りない、</p>
                  <p>営業方法を見直したい！</p>
          ...
          <div class="solution_woman"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/woman1.png" alt=""></div>
        </section>
        <section class="block block-spaceM">
          ...
          <ul class="list-flex list-service">
...
img/main-service4.jpg" alt="">
        ...
        <section class="block block-spaceM">
          ...
          <ol class="list list-flex list-spaceM">
            <li class="list_item-design1">
              <p class="list_item_text-design1">1</p>
              <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/flow-icon1.png" alt="">
            ...
            <li class="list_item-design1">
              <p class="list_item_text-design1">2</p>
              <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/flow-icon2.png" alt="">
            ...
            <li class="list_item-design1">
              <p class="list_item_text-design1">3</p>
              <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/flow-icon3.png" alt="">
            ...
            <li class="list_item-design1">
              <p class="list_item_text-design1">4</p>
              <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/flow-icon4.png" alt="">
        ...
        <section class="contact block block-spaceL">
          <div class="contact_title">
            <p>ご相談・お問い合わせはこちらまで！</p>
            <p class="contact_title_text-sizeS">まずはお気軽にお問い合わせください。</p>
          </div>
          <div class="contact_woman"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/woman2.png" alt=""></div>
