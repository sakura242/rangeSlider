<?php
/* Smarty version 3.1.29, created on 2019-05-29 00:03:41
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/mp/utopia.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ced4dcddf6919_31239972',
  'file_dependency' => 
  array (
    'd978710082aba15e22a9fc475b3f5c9913f4681c' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/mp/utopia.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ced4dcddf6919_31239972 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/mp/mp_main_utopia.png" alt="ユートピア"></div>
												<div class="bg"><h2>UTOPIA<small>ユートピア</small></h2></div>
											</div>
											<div class="inBox font">
												<p>
													スレていない純情な子に相手してほしいならここはオススメ！モデルクラスは北部出身の色白美人が多いと評判。さらに、モデルクラスと言えばビジュアルありきが多いが、サービスも濃厚♪
												</p>
											</div>
											<section>
												<h3>設備／こだわり情報</h3>
...
img/sp/shop/shop_icon_wifi_off.png" alt="wi-fi"><br>なし</th>
																	<td>
																		<img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/shop_icon_wifi_on.png" alt="wi-fi">
																		<img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
													...
													<div class="tableBox">
														<table>
															<tbody>
																...
																<tr>
																	<th>住所</th><td>69/1-3 Rama9 Rd.,Huaykwang,Bangkok 10320</td>
																</tr>
																<tr>
																	<th>連絡先</th><td>02-354-1300</td>
																</tr>
																<tr>
																	<th>営業時間</th><td>13:00～24：00</td>
																</tr>
																<tr>
																	<th>定休日</th><td>大晦日・元旦</td>
																</tr>
																<tr>
																	<th>アクセス</th><td>MRTラマ9世駅よりタクシー約5分</td>
																</tr>
																<tr>
																	<th>取扱いカード</th>
																	<td>VISA、MASTER、AMEX
...
img/shop/credit_mc.png" alt="MC">
																			<img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/credit_ae.png" alt="AE">
																		</span>
																	</td>
																</tr>
																<tr>
																	<th>VIPルーム</th><td>多数有り。部屋の広さにより別途1,000～3,500バーツかかります。</td>
																</tr>
																<tr>
																	<th>メニュー</th>
																	<td>90分：2,000～7,100バーツ(女性により料金が異なります)</td>
																</tr>
															</tbody>
														</table>
													</div>
...
img/shop/girl/girl_img93.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img94.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img95.jpg" alt="" class="img-width-100"></li>
													</ul>
													<ul>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img96.jpg" alt="" class="img-width-100"></li>
													</ul>
												</div>
											</div>
										</section>
									...
									<div class="content">
										<section>
											...
											<div class="subBox">
												<div class="mapBorder">
													<div id="maps">
														<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d31002.48342117144!2d100.572367!3d13.760144000000002!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x2003bfead80fce33!2sUtopia+Sauna+%26+Massage!5e0!3m2!1sja!2sjp!4v1433050379834" width="90%" height="300" frameborder="0" style="border:0"></iframe>
													</div>
												</div>
											</div>
										</section>
