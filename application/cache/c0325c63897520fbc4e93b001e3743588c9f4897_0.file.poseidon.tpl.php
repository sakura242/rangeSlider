<?php
/* Smarty version 3.1.29, created on 2019-05-29 00:03:29
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/mp/poseidon.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ced4dc15fa650_46559886',
  'file_dependency' => 
  array (
    'c0325c63897520fbc4e93b001e3743588c9f4897' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/mp/poseidon.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ced4dc15fa650_46559886 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/mp/mp_main_poseidon.png" alt="ポセイドン"></div>
												<div class="bg"><h2>POSEIDON<small>ポセイドン</small></h2></div>
											</div>
											<div class="inBox font">
												<p>
													「ナタリー」と同じく日本人に絶大な人気を誇るお店です。短期旅行者であれば、一度は来る価値あり！？
												</p>
											</div>
											<section>
												<h3>設備／こだわり情報</h3>
												...
												<div class="subBox">
													<div class="tableBox">
														<table>
															<tbody>
																<tr>
																	<th>店舗名</th><td>ポセイドン（POSEIDON）</td>
																</tr>
																<tr>
																...
																<tr>
																	<th>住所</th><td>209 Ratchadapisek Rd.Din Daeng,Bangkok 10320</td>
																</tr>
																<tr>
																	<th>連絡先</th><td> 02-693-8222</td>
																</tr>
																<tr>
																...
																<tr>
																	<th>アクセス</th><td>MRTラチャダーピセーク駅より徒歩約15分</td>
																</tr>
																<tr>
																	<th>取扱いカード</th>
																	<td>－</td>
																...
																<tr>
																	<th>メニュー</th>
																	<td>90分：2,000～5,500バーツ(女性により料金が異なります)</td>
																</tr>
															</tbody>
														</table>
													</div>
...
img/shop/girl/girl_img89.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img90.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img91.jpg" alt="" class="img-width-100"></li>
													</ul>
													<ul>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img92.jpg" alt="" class="img-width-100"></li>
													</ul>
												</div>
											</div>
										</section>
									...
									<div class="content">
										<section>
											...
											<div class="subBox">
												<div class="mapBorder">
													<div id="maps">
														<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1937.6870525444674!2d100.53973!3d13.75629899307377!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x75972f6fc8feb07d!2sPoseidon!5e0!3m2!1sja!2sjp!4v1433050638868" width="90%" height="300" frameborder="0" style="border:0"></iframe>
													</div>
												</div>
											</div>
										</section>
