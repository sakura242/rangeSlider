<?php
/* Smarty version 3.1.29, created on 2019-06-08 19:30:12
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/massage/mango.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5cfb8e348069d7_66913397',
  'file_dependency' => 
  array (
    '80a8be969a64bb3fcdfcd13f2538538542ce2d1a' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/massage/mango.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5cfb8e348069d7_66913397 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/massage/massage_main_mango.png" alt="Mango Massage"></div>
												<div class="bg"><h2>Mango Massage<small>マンゴーマッサージ</h2></div>
											</div>
											<div class="inBox font">
												<p>
													スクンビットソイ24にある「mango massage」。
													エロ系マッサージ激戦区のエリアにあるだけあってエロイ女の子がたくさん！
													さらにサービスの質も良く、お店も大好評の模様！
													エロさを重視する方にはオススメのお店で、このエロさを体験したら病みつきになるかも！？
												</p>
											</div>
											<section>
												<h3>設備／こだわり情報</h3>
												...
												<div class="subBox">
													<div class="tableBox">
														<table>
															<tbody>
																<tr>
																	<th>店舗名</th><td>マンゴーマッサージ（Mango Massage）</td>
																</tr>
																<tr>
																	<th>地域</th><td>その他</td>
																</tr>
																...
																<tr>
																	<th>住所</th><td>Sukhumvit 24, Klongton, Klongtoey, Bangkok,10110</td>
																</tr>
																<tr>
																	<th>連絡先</th><td>02-258-5313</td>
																</tr>
																<tr>
...
img/shop/credit_mc.png" alt="MC">
																...
																<tr>
																	...
																	<td class="menuBox">
																		...
																		<dl>
																			<dt>ファッションコース</dt>
																			<dd>60分：1,700バーツ　90分：1,800バーツ</dd>
																		</dl>
																		<dl>
																			<dt>アカッスリ・ファッション</dt>
																			<dd>90分：1,900バーツ</dd>
																		...
																		<dl>
																			<dt>マッサージ</dt>
																			<dd>60分：2,200バーツ　90分：2,300バーツ</dd>
																		</dl>
																		<dl>
																			<dt>スクラブ・マッサージ</dt>
																			<dd>90分：2,400バーツ</dd>
									...
									<div class="content">
										<section>
											...
											<div class="subBox">
												<div class="mapBorder">
													<div id="maps">
														<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d31005.931091593597!2d100.568035!3d13.734101!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDQ0JzAyLjgiTiAxMDDCsDM0JzA0LjkiRQ!5e0!3m2!1sen!2sus!4v1451902123733" width="90%" height="300" frameborder="0"></iframe>
													</div>
												</div>
											</div>
										</section>
