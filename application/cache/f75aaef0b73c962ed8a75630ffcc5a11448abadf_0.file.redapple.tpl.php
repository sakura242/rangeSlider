<?php
/* Smarty version 3.1.29, created on 2019-05-25 08:41:02
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/karaoke/redapple.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce8810e9d4b11_10344128',
  'file_dependency' => 
  array (
    'f75aaef0b73c962ed8a75630ffcc5a11448abadf' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/karaoke/redapple.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce8810e9d4b11_10344128 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>Red Apple<small>レッドアップル</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/karaoke/karaoke_main_redapple.png" alt="Red Apple" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>レッドアップル（Red Apple）</td>
														</tr>
														<tr>
															<th>地域</th><td>タニヤ</td>
														</tr>
														...
														<tr>
															<th>住所</th><td>1/46 Sukhumvit 39,Bangkok 10110</td>
														</tr>
														<tr>
															<th>連絡先</th><td>02-234-6110</td>
														</tr>
														<tr>
															<th>営業時間</th><td>18:00～01:00</td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td class="menuBox">
																<dl>
																	...
																	<dd>
																		ビール：100バーツより<br>
																		ウイスキー（シーバス/ブラックレーベル）：150バーツ/グラス<br>
																		焼酎（いいちこ）：150バーツ/グラス<br>
																		*スナック付き
																	</dd>
																</dl>
															</td>
