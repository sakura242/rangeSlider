<?php
/* Smarty version 3.1.29, created on 2019-05-24 14:11:12
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/mp/office.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce77cf0a11087_52833394',
  'file_dependency' => 
  array (
    '368a181d785a65d7dfea1690a325392db3fe2fa3' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/mp/office.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce77cf0a11087_52833394 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
search/mp/">マッサージパーラー検索</a></li>
		<li>お店情報（The Office）</li>
	</ul>
</nav>
<div id="contents"><!-- CONTENTS -->
<div class="mc">
	<article class="page">
		<h1>お店情報（The Office）</h1>
		<div class="mcBox mcb">
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>The Office<small>オフィス</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/mp/mp_main_office.png" alt="The Office" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											ラマ9世通りをラチャダービセークから、東に向かったところに「オフィス」があります。
											高級感のある外観、店内、そして女の子がたくさん！また一般的なマッサージパーラーでは、金魚鉢と呼ばれるところに
											女の子が座っていますが、店内のフロアに普通に座っている感じがまた良い味を出しています。
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>オフィス（The Office）</td>
														</tr>
														<tr>
														...
														<tr>
															<th>住所</th><td>578 Rama 9 Rd, Bangkapi, Huaykwang, Bangkok</td>
														</tr>
														<tr>
															<th>連絡先</th><td>02-716-9030</td>
														</tr>
														<tr>
