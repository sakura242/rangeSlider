<?php
/* Smarty version 3.1.29, created on 2019-05-27 20:49:34
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/gogo/shark.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5cebceceae1704_64355376',
  'file_dependency' => 
  array (
    'a3a9b7118668014f49ec16b921861696e97dbfee' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/gogo/shark.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5cebceceae1704_64355376 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/gogo/gogo_main_shark.png" alt="Shark"></div>
												<div class="bg"><h2>Shark<small>シャーク</small></h2></div>
											</div>
											<div class="inBox font">
												<p>
													店内はそれほど広くはないが、白いコスチュームを身にまとった女の子がただただセクシーな「Shark」 日本人好みのロリ系は少ないが、大人っぽいキレイ系の女の子が好みなのであればオススメ！の理由。
													踊っている間は一人一人を良く見られるように考えて配置されているところも良い。
												</p>
											</div>
											<section>
...
img/sp/shop/shop_icon_receipt_off.png" alt="領収書">
																		<img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/sp/shop/shop_icon_smoking_off.png" alt="喫煙">
																		<img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
...
img/shop/girl/girl_img09.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img10.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img11.jpg" alt="" class="img-width-100"></li>
													</ul>
													<ul>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img12.jpg" alt="" class="img-width-100"></li>
													</ul>
												</div>
											</div>
										</section>
									...
									<div class="content">
										<section>
											...
											<div class="subBox">
												<div class="mapBorder">
													<div id="maps">
														<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15503.014441177214!2d100.56822518258666!3d13.733361602121207!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e29ee33cfb207d%3A0x1380e8861e2db80a!2sSoi+Cowboy%2C+Khwaeng+Khlong+Toei+Nuea%2C+Khet+Watthana%2C+Krung+Thep+Maha+Nakhon+10110+%E3%82%BF%E3%82%A4!5e0!3m2!1sja!2sjp!4v1436770965476" width="90%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
													</div>
												</div>
											</div>
										</section>
