<?php
/* Smarty version 3.1.29, created on 2019-05-28 10:43:53
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/gogo/reinbow1.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5cec9259474970_33866313',
  'file_dependency' => 
  array (
    'adf340ffc25420445fff7d736d3484d7dbc500fd' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/gogo/reinbow1.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5cec9259474970_33866313 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>Rainbow1<small>レインボー1</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/gogo/gogo_main_reinbow1.png" alt="Rainbow1" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											ナナプラザ１階右手前。「プレイスクール」隣り。ナナに４店舗を構える超人気店レインボーグループの１号店。１階にある１と２は地の利を生かして大繁盛。ナナに行ったらとりあえずレインボー系は覗いておこう。
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>レインボー1（Rainbow1）</td>
														</tr>
														<tr>
															<th>地域</th><td>ナナプラザ</td>
														</tr>
														<tr>
															<th>業態</th><td>カラオケ</td>
														</tr>
														<tr>
															<th>住所</th><td>Ground Floor 115-116 Nana Plaza Soi 4 Sukhumvit Rd., Klongton, Klongtoei, Bangkok 1011</td>
														</tr>
														<tr>
															<th>連絡先</th><td>－</td>
														</tr>
														...
														<tr>
															<th>アクセス</th><td>BTSナナ駅から徒歩5分、地下鉄スクンビット駅から徒歩12分</td>
														</tr>
														<tr>
															<th>取扱いカード</th>
															<td>
...
img/shop/girl/girl_img13.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img14.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img125.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img126.jpg" alt="" width="150" height="200"></li>
											</ul>
										</div>
									</div>
								</section>
							...
							<div class="content">
								<section>
									...
									<div class="subBox">
										<div class="mapBorder">
											<div id="maps">
												<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d31004.94800094147!2d100.55311600000002!3d13.741532!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xcf9ae02a2fa5af89!2sNana+VIP+Nightclub+Party+Bangkok!5e0!3m2!1sja!2sus!4v1436756222244" width="642" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
											</div>
										</div>
									</div>
								</section>
