<?php
/* Smarty version 3.1.29, created on 2019-05-28 10:43:18
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/gogo/reinbow3.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5cec923638bd84_12626583',
  'file_dependency' => 
  array (
    'd2de17621570f77f797f3695475c5e144a1745e8' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/gogo/reinbow3.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5cec923638bd84_12626583 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>Rainbow3<small>レインボー3</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/gogo/gogo_main_reinbow3.png" alt="Rainbow3" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											ナナプラザ２階手前。ナナといえば安心のレインボーグループのひとつ。ナナにはたくさんのゴーゴーがあり、どこにいけばわからないという人は「レインボー」と名の付く店に行っておけば安心。
											ナナに行ったらとりあえずレインボー系は覗いておこう。
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>レインボー3（Rainbow3）</td>
														</tr>
														<tr>
...
img/shop/girl/girl_img141.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img149.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img19.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img20.jpg" alt="" width="150" height="200"></li>
											</ul>
										</div>
									</div>
								</section>
