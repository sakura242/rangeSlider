<?php
/* Smarty version 3.1.29, created on 2019-05-22 18:28:43
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/massage/angel.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce5164b0f06a9_72956358',
  'file_dependency' => 
  array (
    'b573cc8e99480bd173b6d4012af4cc8f730e24bf' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/massage/angel.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce5164b0f06a9_72956358 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/massage/massage_main_angel.png" alt="エンジェル"></div>
												<div class="bg"><h2>Angel<small>エンジェル</small></h2></div>
											</div>
											<div class="inBox font">
												<p>
													日本人好みの女の子が多いと大人気のエンジェルマッサージ。
													女の子を採用する前に必ずテストを実施しサービス確認する念の入れようで中身も充実。
												</p>
											</div>
											<section>
												<h3>設備／こだわり情報</h3>
													...
													<div class="tableBox">
														<table>
															<tbody>
																...
																<tr>
																	<th>住所</th><td>6/7-8 Soi26 Sukhumvit RD,Klongtoey,Bangkok 10110</td>
																</tr>
																<tr>
																	<th>連絡先</th><td>02-665-6265／087-986-7246<br>日本人スタッフが対応します。</td>
																</tr>
																<tr>
																...
																<tr>
																	<th>アクセス</th><td>BTSプロムポン駅から徒歩5分</td>
																</tr>
																<tr>
																	<th>取扱いカード</th>
																	<td>情報なし</td>
																...
																<tr>
																	<th>メニュー</th>
																	<td>
																		オイルマッサージ(60分)　400バーツ<br>
																		オイルマッサージ(90分)　600バーツ<br>
																		オイルマッサージ(120分)　800バーツ<br>
																		ローションマッサージ(60分)　600バーツ<br>
																		ローションマッサージ(90分)　800バーツ<br>
																		ローションマッサージ(120分)　1,000バーツ<br>
																		タイマッサージ(60分)　300バーツ<br>
																		タイマッサージ(120分)　400バーツ
																	</td>
																</tr>
															</tbody>
...
img/shop/girl/girl_img61.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img62.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img63.jpg" alt="" class="img-width-100"></li>
													</ul>
													<ul>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img64.jpg" alt="" class="img-width-100"></li>
													</ul>
												</div>
											</div>
										</section>
									...
									<div class="content">
										<section>
											...
											<div class="subBox">
												<div class="mapBorder">
													<div id="maps">
														<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d31006.62559496439!2d100.570537!3d13.728849!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDQzJzQzLjkiTiAxMDDCsDM0JzEzLjkiRQ!5e0!3m2!1sen!2sus!4v1433127555743" width="90%" height="300" frameborder="0" style="border:0"></iframe>
													</div>
												</div>
											</div>
										</section>
