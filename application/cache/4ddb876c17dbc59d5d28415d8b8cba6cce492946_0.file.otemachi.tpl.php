<?php
/* Smarty version 3.1.29, created on 2019-05-22 07:39:06
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/massage/otemachi.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce47e0a089df8_06320055',
  'file_dependency' => 
  array (
    '4ddb876c17dbc59d5d28415d8b8cba6cce492946' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/massage/otemachi.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce47e0a089df8_06320055 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/massage/massage_main_otemachi.png" alt="大手町商事"></div>
												<div class="bg"><h2>Ohtemachi Shouji<small>大手町商事</small></h2></div>
											</div>
											<div class="inBox font">
												<p>
													滋賀県の雄琴にあるソープランド、大手町商事がタイのバンコクに上陸！！
													そのサービスレベルの高さで知られる本物のマットプレイを始めその接客レベルをお試しあれ！
												</p>
											</div>
											<section>
												<h3>設備／こだわり情報</h3>
...
img/shop/shop_icon_vip_on.png" alt="VIPルーム">
																		<img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/shop_icon_bath_on.png" alt="バスタブ">
																		<img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/shop_icon_shower_on.png" alt="シャワー">
																		<img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/shop_icon_date_on.png" alt="店外デート">
																		<img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/shop_icon_cosplay_on.png" alt="コスプレ">
																		<img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
...
img/shop/shop_icon_2play_on.png" alt="２回戦">
																...
																<tr>
																	<th>その他</th>
																	<td>
																		日本語・英語：出来る女の子とできない女の子がいます<br>バス：ありとなしのお部屋があります<br>
																		コスプレ：OL風<br>ローション：コースによって異なります<br>2回戦：出来る女の子とできない女の子がいます
																	</td>
																</tr>
															</tbody>
														</table>
												...
												<div class="subBox">
													<div class="tableBox">
														<table>
															<tbody>
																<tr>
																	<th>店舗名</th><td>大手町商事（Ohtemachi Shouji）</td>
																</tr>
																<tr>
																	<th>地域</th><td>その他</td>
																</tr>
																...
																<tr>
																	<th>住所</th><td>Soi26 Sukhumvit RD,Klongtoey,Bangkok 10110</td>
																</tr>
																<tr>
																	<th>連絡先</th>
																	<td>
																		タイ大手町商事02-661-2929*日本人スタッフが対応します。<br>
																		タイ大手町商事PART2 02-661-3710*日本人スタッフが対応します。<br>
																		プレミアム大手商事02-261-5849*日本人スタッフが対応します。
																	</td>
																</tr>
																<tr>
																...
																<tr>
																	<th>アクセス</th><td>BTSプロンポン駅より徒歩約1分</td>
																</tr>
																	<th>取扱いカード</th><td>VIZA、MASTER<span><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/credit_viza.png" alt="VISA"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/credit_mc.png" alt="MC"></span></td>
																<tr>
																	<th>VIPルーム</th><td>全部屋個室</td>
																</tr>
																<tr>
																	<th>メニュー</th>
																	<td>
																		シャワールーム(60分)　2,800バーツ<br>
																		シャワールーム(70分)　3,000バーツ<br>
																		シャワールーム(90分)　3,3000バーツ<br>
																		ジャグジールーム(60分)　3,000バーツ<br>
																		ジャグジールーム(70分)　3,3000バーツ<br>
																		ジャグジールーム(90分)　3,500バーツ<br>
																		スペシャルコース(90分)　3,600バーツ
																	</td>
																</tr>
															</tbody>
														</table>
...
img/shop/girl/girl_img73.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img74.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img75.jpg" alt="" class="img-width-100"></li>
													</ul>
													<ul>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img76.jpg" alt="" class="img-width-100"></li>
													</ul>
												</div>
											</div>
										</section>
									...
									<div class="content">
										<section>
											...
											<div class="subBox">
												<div class="mapBorder">
													<div id="maps">
														<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15503.515190656424!2d100.562907!3d13.725787!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDQzJzQ0LjUiTiAxMDDCsDM0JzE0LjMiRQ!5e0!3m2!1sen!2sus!4v1433131858169" width="90%" height="300" frameborder="0" style="border:0"></iframe>
													</div>
												</div>
											</div>
										</section>
