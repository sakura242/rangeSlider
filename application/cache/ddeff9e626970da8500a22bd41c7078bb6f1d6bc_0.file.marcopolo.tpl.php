<?php
/* Smarty version 3.1.29, created on 2019-05-28 10:43:19
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/karaoke/marcopolo.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5cec9237546e33_57813861',
  'file_dependency' => 
  array (
    'ddeff9e626970da8500a22bd41c7078bb6f1d6bc' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/karaoke/marcopolo.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5cec9237546e33_57813861 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
search/karaoke/">カラオケ検索</a></li>
		<li>お店情報（Marco Polo）</li>
	</ul>
</nav>
<div id="contents"><!-- CONTENTS -->
<div class="mc">
	<article class="page">
		<h1>お店情報（Marco Polo）</h1>
		<div class="mcBox mcb">
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>Marco Polo<small>マルコポーロ</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/karaoke/karaoke_main_marco_maerma.png" alt="Marco Polo" width="650" height="300"></div>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										<div class="subBox">
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>マルコポーロ（Marco Polo）</td>
														</tr>
														<tr>
															<th>地域</th><td>タニヤ</td>
														</tr>
														...
														<tr>
															<th>住所</th><td>3-4th FL.,31/3 Soi Thaniya, Surawongse Rd., Bangrak, Bangkok 10500</td>
														</tr>
														<tr>
															...
															<td class="menuBox">
																...
																<dl>
																	...
																	<dd>
																		...
																		ジョニーウォーカー(ブラックラベル)：2,200バーツ<br>
																		ジョニーウォーカー(ゴールドラベル)：2,400バーツ<br>
																		ジョニーウォーカー(グリーンラベル)：2,800バーツ<br>
