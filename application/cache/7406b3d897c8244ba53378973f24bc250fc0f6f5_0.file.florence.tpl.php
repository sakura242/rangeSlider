<?php
/* Smarty version 3.1.29, created on 2019-05-24 04:25:48
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/coyote/florence.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce6f3bc283ac8_11429775',
  'file_dependency' => 
  array (
    '7406b3d897c8244ba53378973f24bc250fc0f6f5' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/coyote/florence.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce6f3bc283ac8_11429775 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/coyote/coyote_main_florence.png" alt="FLORENCE"></div>
												<div class="bg"><h2>FLORENCE<small>フローレンス</small></h2></div>
											</div>
											<div class="inBox font">
												<p>
												バンコクでコヨーテと言えばシーナカリンの【フローレンス】でキマリ！メンバーにならなくたって十分に楽しめちゃうので観光客だって安心！しかもローカルにしては明朗会計な超優良店ですぞ！コヨーテの他にも風呂あり！カラオケあり！超有名な海鮮レストランありの巨大なエロチックアミューズメント施設！さあ、今すぐシーナカリンに進路を取るべし！100名以上がスタンバイしている【フローレンス】の美女たちのサービスで皆様を秒殺しちゃいますぞ！
												</p>
											</div>
											<section>
												<h3>設備／こだわり情報</h3>
												...
												<div class="subBox">
													<div class="tableBox">
														<table>
															<tbody>
																<tr>
																	<th>店舗名</th><td>フローレンス（FLORENCE）</td>
																</tr>
																<tr>
																	<th>地域</th><td>シーナカリン</td>
																</tr>
																<tr>
																	<th>業態</th><td>コヨーテ</td>
																</tr>
																<tr>
																	<th>住所</th><td>916 Srinakarin Rd.,Suanluang, Bangkok 10240</td>
																</tr>
																<tr>
																	<th>連絡先</th><td>02-322-5530</td>
																</tr>
																<tr>
																...
																<tr>
																	<th>アクセス</th><td>MRTオンヌット駅よりタクシーで約30分</td>
																</tr>
																<tr>
																	<th>取扱いカード</th><td>VISA、MASTER、AMEX<span><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/credit_viza.png" alt="VISA"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/credit_mc.png" alt="MC"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/credit_ae.png" alt="AE"></span></td>
																</tr>
																<tr>
																	<th>メンバー料金</th>
																	<td>10,000バーツ又は20,000バーツ<br>ウイスキー4本又は9本と割り物無料<br>ボトルは6ヶ月間保管可能です。</td>
																</tr>
																<tr>
...
img/shop/girl/girl_img105.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img106.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img107.jpg" alt="" class="img-width-100"></li>
													</ul>
													<ul>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img108.jpg" alt="" class="img-width-100"></li>
													</ul>
												</div>
											</div>
										</section>
