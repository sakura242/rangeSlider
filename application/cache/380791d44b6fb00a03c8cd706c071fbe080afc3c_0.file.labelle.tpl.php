<?php
/* Smarty version 3.1.29, created on 2019-06-01 08:43:07
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/mp/labelle.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5cf1bc0b1c2023_90607668',
  'file_dependency' => 
  array (
    '380791d44b6fb00a03c8cd706c071fbe080afc3c' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/mp/labelle.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5cf1bc0b1c2023_90607668 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/mp/mp_main_labelle.png" alt="ラベル"></div>
												<div class="bg"><h2>La belle<small>ラベル</small></h2></div>
											</div>
											<div class="inBox font">
												<p>
													モデルクラスのビジュアルはかなり高く、部屋の内装も非常にキレイ！特にバンコクでも唯一のスチームサウナは大好評！！
												</p>
											</div>
											<section>
												<h3>設備／こだわり情報</h3>
													...
													<div class="tableBox">
														<table>
															<tbody>
																...
																<tr>
																	<th>住所</th><td>1765 New Petchburi Rd.,Bangkapi,Bangkok 10310</td>
																</tr>
																<tr>
																	<th>連絡先</th><td>02-652-8700</td>
																</tr>
																<tr>
																...
																<tr>
																	<th>アクセス</th><td>MRTペップリー駅より徒歩約5分</td>
																</tr>
																<tr>
																	<th>取扱いカード</th>
																	<td>VIZA、MASTER、JCB、AMEX
																		<span>
																			<img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
...
img/shop/credit_ae.png" alt="AE">
																...
																<tr>
																	<th>セット料金</th><td>情報なし<!--1時間 800バーツ<br><small>（飲み放題、女の子のドリンク、フルーツ、テーブルチャージ、税、サービス料込）</small>--></td>
																</tr>
																<tr>
																	<th>VIPルーム</th><td>情報なし</td>
																</tr>
																<tr>
																	<th>メニュー</th>
...
img/shop/girl/girl_img97.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img98.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img99.jpg" alt="" class="img-width-100"></li>
													</ul>
													<ul>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img100.jpg" alt="" class="img-width-100"></li>
													</ul>
												</div>
											</div>
										</section>
									...
									<div class="content">
										<section>
											...
											<div class="subBox">
												<div class="mapBorder">
													<div id="maps">
														<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d31003.86376115689!2d100.569363!3d13.749723!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDQ0JzU2LjEiTiAxMDDCsDMzJzU5LjUiRQ!5e0!3m2!1sja!2sjp!4v1433050721134" width="90%" height="300" frameborder="0" style="border:0"></iframe>
													</div>
												</div>
											</div>
										</section>
