<?php
/* Smarty version 3.1.29, created on 2019-05-27 06:31:41
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/coyote/piano.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ceb05bdcf2b99_72545853',
  'file_dependency' => 
  array (
    '4d68ef851428bc17641c4fbe86c5a175a9eebc6a' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/coyote/piano.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ceb05bdcf2b99_72545853 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>Piano<small>ピアノ</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/coyote/coyote_main_piano.png" alt="Piano" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>「最上級の女の子と遊びたいけどコヨーテは激しすぎるから・・」と悩んでいるそこのあなた！コヨーテよりは落ち着いた程よいアップテンポのサービス「ピアノ」で満喫してみては？</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										<div class="subBox">
											...
											<div class="tableBox">
												<table>
													<tbody>
														...
														<tr>
															<th>住所</th><td>45 Soi Sukhumvit 63,Ekamai Rd.,Across BIG-C Shopping Center,Bangkok 10110</td>
														</tr>
														<tr>
															<th>連絡先</th><td>02-714-1543</td>
														</tr>
														<tr>
...
img/shop/credit_mc.png" alt="MC" width="45" height="27">
														...
														<tr>
															<th>メンバー料金</th>
															<td>20,000バーツ<br>ウイスキー7本と割り物無料<br>ボトルは6ヶ月間保管可能です。</td>
														</tr>
														<tr>
...
img/shop/girl/girl_img58.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img118.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img119.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img120.jpg" alt="" width="150" height="200"></li>
											</ul>
										</div>
									</div>
								</section>
							...
							<div class="content">
								<section>
									...
									<div class="subBox">
										<div class="mapBorder">
											<div id="maps">
												<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15503.468330859447!2d100.584982!3d13.726496!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xde7eced158a5336c!2sThe+Piano!5e0!3m2!1sja!2sjp!4v1433044395582" width="642" height="450" frameborder="0" style="border:0"></iframe>
											</div>
										</div>
									</div>
								</section>
