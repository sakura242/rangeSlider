<?php
/* Smarty version 3.1.29, created on 2019-05-24 14:02:08
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/mp/ladefense.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce77ad05c1e19_61813348',
  'file_dependency' => 
  array (
    '4d36431c750887930af77cbdfefb4e289c8094da' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/mp/ladefense.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce77ad05c1e19_61813348 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
search/mp/">マッサージパーラー検索</a></li>
		<li>お店情報（La Defense）</li>
	</ul>
</nav>
<div id="contents"><!-- CONTENTS -->
<div class="mc">
	<article class="page">
		<h1>お店情報（La Defense）</h1>
		<div class="mcBox mcb">
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>La Defense<small>ラ・デファンス</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/mp/mp_main_ladefense.png" alt="La Defense" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											最寄駅から遠い立地にあるので、旅行者は少ないがＭＰ嬢のレベルが高いことから、在住の方達から高い支持を得ている名店。
											この近辺には、他にもマッサージパーラーが点在しているので、他と合わせて覗いてみるのも面白いかも。
											日本人好みのロリ系の女の子たちがたくさんいるので、どの女の子を選ぼうか迷うこと必至！
											お店の指導もしっかりしているので満足すること間違いなし！
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>ラ・デファンス（La Defense）</td>
														</tr>
														<tr>
														...
														<tr>
															<th>住所</th><td>333, Asok-Din Daeng, Bangkok 10400</td>
														</tr>
														<tr>
															<th>連絡先</th><td>02-642-0806</td>
														</tr>
														<tr>
