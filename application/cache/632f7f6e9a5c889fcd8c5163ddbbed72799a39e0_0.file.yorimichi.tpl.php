<?php
/* Smarty version 3.1.29, created on 2019-06-17 14:15:16
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/massage/yorimichi.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5d0721e4dee513_09299252',
  'file_dependency' => 
  array (
    '632f7f6e9a5c889fcd8c5163ddbbed72799a39e0' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/massage/yorimichi.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5d0721e4dee513_09299252 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/massage/massage_main_yorimichi.png" alt="より道"></div>
												<div class="bg"><h2>より道</small></h2></div>
											</div>
											<div class="inBox font">
												<p>
													より道マッサージは2012年7月1日、スクンビットソイ26にオープン。
													部屋は全部で28部屋あり、バンコクを一望できるビッグサイズのパノラマルーム1つ、バスルーム18つ、
													9つのシャワールームとなっており、どのお部屋も清潔で快適な空間となっています。
													女の子は50人ほど在籍しているので、アナタ好みの女の子を見つけれるはず！
													女の子一人ひとりしっかりと教育されているので、いままでに体感したことがない極上のマッサージを堪能できること間違いなしです！
												</p>
											</div>
											<section>
												<h3>設備／こだわり情報</h3>
													...
													<div class="tableBox">
														<table>
															<tbody>
																...
																<tr>
																	<th>住所</th><td>25/1, Sukhumvit 26, Klongton, Klongtoey, Bangkok,10110</td>
																</tr>
																<tr>
																	<th>連絡先</th><td>02-661-4998</td>
																</tr>
																<tr>
...
img/shop/credit_mc.png" alt="MC">
																...
																<tr>
																	...
																	<td class="menuBox">
																		<dl>
																			<dt>オイルマッサージ</dt>
																			<dd>40分：1,800バーツ　60分：2,100バーツ　90分：2,200バーツ　120分：2,400バーツ</dd>
																		</dl>
																		<dl>
																			<dt>ジェルマッサージ</dt>
																			<dd>40分：1,900バーツ　60分：2,200バーツ　90分：2,300バーツ　120分：2,500バーツ</dd>
																		</dl>
																	</td>
																</tr>
																<tr>
																	...
																	<td class="menuBox">
																		<dl>
																			<dt>オイルマッサージ</dt>
																			<dd>60分：2,200バーツ　90分：2,400バーツ　120分：2,600バーツ</dd>
																		</dl>
																		<dl>
																			<dt>ジェルマッサージ</dt>
																...
																<tr>
																	<th>メニュー<br>ジャクジー付きパノラマルーム</th>
																	<td class="menuBox">
																		<dl>
																			<dt>オイル+ジェルマッサージ</dt>
																			<dd>90分：2,800バーツ　120分：3,000バーツ</dd>
																		</dl>
																		<dl>
																			<dt>オイル+ジェルマッサージ（女の子2人）</dt>
																			<dd>120分：4,500バーツ</dd>
																		</dl>
																	</td>
																</tr>
									...
									<div class="content">
										<section>
											...
											<div class="subBox">
												<div class="mapBorder">
													<div id="maps">
														<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d31006.713909923918!2d100.570543!3d13.728181!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDQzJzQxLjUiTiAxMDDCsDM0JzEzLjkiRQ!5e0!3m2!1sen!2sus!4v1451900594494" width="90%" height="300" frameborder="0"></iframe>
													</div>
												</div>
											</div>
										</section>
