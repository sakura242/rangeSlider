<?php
/* Smarty version 3.1.29, created on 2019-05-24 01:30:13
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/night/cafe.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce6ca955fdc42_82642456',
  'file_dependency' => 
  array (
    'ab61da144ce72a5faba5cda314dba54635511016' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/night/cafe.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce6ca955fdc42_82642456 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
search/">お店検索</a></li>
		<li><a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
search/night/">ナイトスポット検索</a></li>
		<li>お店情報（THERMAE CAFE）</li>
	</ul>
</nav>
<div id="contents"><!-- CONTENTS -->
<div class="mc">
	<article class="page">
		<h1>お店情報（THERMAE CAFE）</h1>
		<div class="mcBox mcb">
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>THERMAE CAFE<small>テーメーカフェ</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/night/night_main_cafe.png" alt="THERMAE CAFE" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											テーメーカフェは表向きはカフェ・バーとして営業していますが、出会喫茶としてよく知られており、店内にいる女の子は値段交渉の上持ち帰る事が出来ます。
											どこのお店にも属さないフリーの女の子が多いが、日本人向けカラオケクラブの多いタニヤで働いていた子、その他にもゴーゴーバー、MPの経験者や現役で夜のお店で働いている嬢も多数待機しており、
											簡単な日本語であれば話せる女の子が多いです。ちなみに店外で客を探している女の子もいるが、店内へのレディーボーイの入店が禁止されているため、レディーボーイの方が多いのでご注意を！
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>テーメーカフェ(THERMAE CAFE)</td>
														</tr>
														<tr>
															<th>地域</th><td>その他</td>
														</tr>
														<tr>
															<th>業態</th><td>ナイトスポット</td>
														</tr>
														<tr>
															<th>住所</th><td>Sukhumvit Road (near Soi 15).Klong Toey, Wattana Bangkok 10110</td>
														</tr>
														<tr>
															<th>営業時間</th><td>20：00～02：00</td>
														</tr>
														<tr>
															<th>定休日</th><td>王室関連の祝日<br>仏教行事の祭日<br>選挙投票日</td>
														</tr>
														<tr>
															<th>アクセス</th><td>BTSのアソーク駅、ナナ駅の中間辺り（徒歩約10分）</td>
														</tr>
														<tr>
															<th>メニュー</th>
															<td>
																入店料(1ドリンク代)：100バーツ ※必須<br>
																ショート：1,500～2,500バーツ<br>
																ロング：2,500～4,000バーツ
															</td>
														</tr>
													</tbody>
...
img/shop/girl/girl_img121.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img122.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img123.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img124.jpg" alt="" width="150" height="200"></li>
											</ul>
										</div>
									</div>
								</section>
							...
							<div class="content">
								<section>
									...
									<div class="subBox">
										<div class="mapBorder">
											<div id="maps">
												<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15502.639551576407!2d100.5579609!3d13.7390297!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x2190be8b76e6a661!2sThermae!5e0!3m2!1sja!2sjp!4v1450404665953" width="642" height="450" frameborder="0"></iframe>
											</div>
										</div>
									</div>
								</section>
