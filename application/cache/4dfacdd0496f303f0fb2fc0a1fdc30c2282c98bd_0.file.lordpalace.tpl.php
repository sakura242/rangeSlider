<?php
/* Smarty version 3.1.29, created on 2019-05-22 17:10:14
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/mp/lordpalace.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce503e6ee2d77_79502905',
  'file_dependency' => 
  array (
    '4dfacdd0496f303f0fb2fc0a1fdc30c2282c98bd' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/mp/lordpalace.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce503e6ee2d77_79502905 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
search/mp/">マッサージパーラー検索</a></li>
		<li>お店情報（The Lord Palace）</li>
	</ul>
</nav>
<div id="contents"><!-- CONTENTS -->
<div class="mc">
	<article class="page">
		<h1>お店情報（The Lord Palace）</h1>
		<div class="mcBox mcb">
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>The Lord Palace<small>ロードパレス</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/mp/mp_main_lordpalace.png" alt="The Lord Palace" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											ロードパレスは豪華な内装、圧倒的な部屋数とその辺の大衆マッサージパーラーとは、設備も価格も全く違います。
											肝心のＭＰ嬢のレベルは、人の好みはそれぞれですが、さすがは高級店！というだけあってモデル系のスレンダーな女の子がいたりと女の子のレベルは申し分なし！
											しかし、一般的なマッサージパーラーのお店と比べて料金が高めなので、楽しむかどうかはあなた次第！！
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>ロードパレス（The Lord Palace）</td>
														</tr>
														<tr>
														...
														<tr>
															<th>住所</th><td>87 Soi Ratchada 7, Ratchadapisek Rd, Dingdang Bangkok 10400</td>
														</tr>
														<tr>
															<th>連絡先</th><td>02-248-8888</td>
														</tr>
														<tr>
															<th>営業時間</th><td>13:00-24:00</td>
														</tr>
														<tr>
															<th>定休日</th><td>情報なし</td>
														</tr>
														<tr>
															<th>アクセス</th><td>MRTホイクアン駅より徒歩約10分</td>
														</tr>
														<tr>
															<th>取扱いカード</th>
															<td>VISA、MASTER
														...
														<tr>
															<th>メニュー</th>
															<td>90分　3,600～5,000バーツ(女性により料金が異なります。)</td>
														</tr>
													</tbody>
												</table>
											</div>
							...
							<div class="content">
								<section>
									...
									<div class="subBox">
										<div class="mapBorder">
											<div id="maps">
												<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d968.7733242065533!2d100.572304!3d13.773247!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sja!2sus!4v1449649597973" width="642" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
											</div>
										</div>
									</div>
								</section>
