<?php
/* Smarty version 3.1.29, created on 2019-05-21 20:07:20
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/karaoke/f1.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce3dbe864fa54_40943379',
  'file_dependency' => 
  array (
    '2ef7ed019e4e62ffec21934e2cb966c78c14b5ab' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/karaoke/f1.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce3dbe864fa54_40943379 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>CLUB F1<small>クラブ F1</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/karaoke/karaoke_main_f1.png" alt="クラブ F1" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											鳴り物入りでリニューアルオープンしたClub F1。色々な意味でアグレッシブなお店です。
											プライベートでも接待でも楽しいひとときをお楽しみいただけること間違いなし！！
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>クラブ F1（CLUB F1）</td>
														</tr>
														<tr>
															<th>地域</th><td>タニヤ</td>
														</tr>
														...
														<tr>
															<th>住所</th><td>4・5Floor 62/21-23 Soi Thaniya,Surawong,Suriyawong,Bangrak,Bangkok 10500</td>
														</tr>
														<tr>
															<th>連絡先</th><td>091-871-7108(日本語可能)</td>
														</tr>
														<tr>
...
img/shop/credit_mc.png" alt="MC" width="45" height="27">
														...
														<tr>
															<th>セット料金</th>
															<td>70分1,000バーツ（ウイスキー・焼酎飲み放題）スナック又はフルーツ付き</td>
														</tr>
														<tr>
															<th>メニュー</th>
															<td>－</td>
...
img/shop/girl/girl_img156.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img34.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img35.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img36.jpg" alt="" width="150" height="200"></li>
											</ul>
										</div>
									</div>
								</section>
							...
							<div class="content">
								<section>
									...
									<div class="subBox">
										<div class="mapBorder">
											<div id="maps">
												<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d9218.342954014695!2d100.53398063011547!3d13.728390759861389!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDQzJzQ3LjEiTiAxMDDCsDMyJzAxLjYiRQ!5e0!3m2!1sen!2sus!4v1450417670659" width="642" height="450" frameborder="0"></iframe>
											</div>
										</div>
									</div>
								</section>
