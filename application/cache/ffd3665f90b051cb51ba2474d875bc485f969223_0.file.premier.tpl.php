<?php
/* Smarty version 3.1.29, created on 2019-05-25 10:07:40
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/massage/premier.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce8955c767874_87296096',
  'file_dependency' => 
  array (
    'ffd3665f90b051cb51ba2474d875bc485f969223' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/massage/premier.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce8955c767874_87296096 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
search/massage/">マッサージ検索</a></li>
		<li>お店情報（101 Premier Massage）</li>
	</ul>
</nav>
<div id="contents"><!-- CONTENTS -->
<div class="mc">
	<article class="page">
		<h1>お店情報（101 Premier Massage）</h1>
		<div class="mcBox mcb">
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>101 Premier Massage<small>101プレミアマッサージ</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/massage/massage_main_premier.png" alt="101 Premier Massage" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											「お客様にこれまでにない最高の満足感を味わって頂きたい」という我々の基本理念の下、
											他のマッサージ店とは一味も二味も違う「101 Premier Massage」。
											「101 Premier Massage」の自慢は腰が震える程の気持ちいいローションマッサージ！
											ゴシゴシとシゴイて早く終わらせようとする乱暴なマッサージではありません。
											至極の快感を長時間にわたって味わえる究極のマッサージです。是非、腰が震える快楽をご堪能ください。
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>101プレミアマッサージ（101 Premier Massage）</td>
														</tr>
														<tr>
															<th>地域</th><td>その他</td>
														</tr>
														...
														<tr>
															<th>住所</th><td>10/16, Sukhumvit 26, Klongton, Klongtoey, Bangkok,10110</td>
														</tr>
														<tr>
															<th>連絡先</th><td>080-782-2120</td>
														</tr>
														<tr>
															<th>営業時間</th><td>11:00～24:00</td>
														</tr>
														<tr>
															<th>定休日</th><td>無休</td>
														</tr>
														<tr>
															<th>アクセス</th><td>BTSプロンポン駅より徒歩約5分</td>
														</tr>
														<tr>
															<th>取扱いカード</th>
															<td>VISA、MASTER
...
img/shop/credit_mc.png" alt="MC" width="45" height="27">
														...
														<tr>
															...
															<td class="menuBox">
																<dl>
																	<dt>ローションマッサージ</dt>
																	<dd>90分：1,000バーツ　120分：1,200バーツ</dd>
																</dl>
																<dl>
																	<dt>オイルマッサージ</dt>
																	<dd>90分：700バーツ　120分：900バーツ</dd>
																</dl>
																<dl>
																	<dt>タイマッサージ</dt>
																	<dd>90分：700バーツ　120分：900バーツ</dd>
														...
														<tr>
															<th>メニュー<br>シャワールーム</th>
															<td class="menuBox">
																<dl>
																	<dt>ローションマッサージ</dt>
																	<dd>60分：800バーツ　90分：900バーツ　120分：1,100バーツ</dd>
																</dl>
																<dl>
																	<dt>オイルマッサージ</dt>
																	<dd>60分：500バーツ　90分：600バーツ　120分：800バーツ</dd>
																</dl>
																<dl>
																	<dt>タイマッサージ</dt>
																	<dd>60分：500バーツ　90分：600バーツ　120分：800バーツ</dd>
...
img/shop/girl/girl_img176.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img177.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img178.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img179.jpg" alt="" width="150" height="200"></li>
											</ul>
											<ul class="pt15">
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img180.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img181.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img182.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img183.jpg" alt="" width="150" height="200"></li>
											</ul>
											<ul class="pt15">
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img184.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img185.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img186.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img187.jpg" alt="" width="150" height="200"></li>
											</ul>
										</div>
									</div>
								</section>
							...
							<div class="content">
								<section>
									...
									<div class="subBox">
										<div class="mapBorder">
											<div id="maps">
												<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1937.916520777131!2d100.56999!3d13.728556!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x7a95104ababd1e66!2s101+Premier+Massage!5e0!3m2!1sja!2sth!4v1450169866908" width="642" height="450" frameborder="0" style="border:0"></iframe>
											</div>
										</div>
									</div>
								</section>
