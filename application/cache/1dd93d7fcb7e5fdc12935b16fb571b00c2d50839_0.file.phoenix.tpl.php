<?php
/* Smarty version 3.1.29, created on 2019-05-21 14:03:47
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/karaoke/phoenix.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce386b3d19902_15721036',
  'file_dependency' => 
  array (
    '1dd93d7fcb7e5fdc12935b16fb571b00c2d50839' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/karaoke/phoenix.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce386b3d19902_15721036 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/karaoke/karaoke_main_phoenix.png" alt="Phoenix Club"></div>
												<div class="bg"><h2>Phoenix Club<small>フェニックス クラブ</small></h2></div>
											</div>
											<div class="inBox font">
												<p>
													シーロム通りからタニヤ通りに入り右手に「Phoenix Club」があります。
													VIPルームは1室しかなく、少し狭いお店に感じるかもしれませんが、まだOPEN仕立てのお店なので店内はキレイで清潔感がありますよ。
													それと「Phoenix Club」のママさんは、タニヤ№1と言っても過言ではないくらいキレイです！
													お店の女の子も良いですが、ママさんを一度拝見しに行くだけでも価値があるお店ですよ！
												</p>
											</div>
											<section>
												<h3>設備／こだわり情報</h3>
												...
												<div class="subBox">
													<div class="tableBox">
														<table>
															<tbody>
																<tr>
																	<th>店舗名</th><td>フェニックスクラブ（Phoenix Club）</td>
																</tr>
																<tr>
																	<th>地域</th><td>タニヤ</td>
																</tr>
																...
																<tr>
																	<th>住所</th><td>3Floor,62/7, Soi Thaniya,Surawong,Suriyawong,Bangrak,Bangkok 10500</td>
																</tr>
																<tr>
																	<th>連絡先</th><td>085-118-8772</td>
																</tr>
																<tr>
																	<th>営業時間</th><td>19:00-01:00</td>
																</tr>
																<tr>
																	<th>定休日</th><td>禁酒日（仏教の日、王室関係の日、選挙の日など）、タイ旧正月（4/13-15）</td>
																</tr>
																<tr>
...
img/shop/credit_jcb.png" alt="JCB">
																...
																<tr>
																	<th>VIPルーム</th><td>1部屋<br>※部屋代金が500バーツかかります。</td>
																</tr>
																<tr>
																	<th>セット料金</th>
																	<td>
																		60分：600バーツ（ウイスキー・焼酎飲み放題）<br>
																		※スナック又はフルーツ付き
																	</td>
																</tr>
																<tr>
																	<th>メニュー</th>
																	<td class="menuBox">
																		ウイスキー（シーバス）：2,500バーツ<br>
																		焼酎（いいちこ）：1,900バーツ<br>
																		テキーラ：1,900バーツ～<br>
																		シャンパン：2,000バーツ～<br>
																		ワイン（白/赤）：2,000バーツ～<br>
																		ビール（ハイネケン/シンハー）：200バーツ（350ml）<br>
																		ソフトドリンク、コーラ、ソーダ、水、氷：150バーツ<br>
																		レディードリンク：200バーツ
																	</td>
																</tr>
															</tbody>
