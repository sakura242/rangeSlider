<?php
/* Smarty version 3.1.29, created on 2019-05-24 02:09:13
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/mp/avita.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce6d3b9c9f862_32235415',
  'file_dependency' => 
  array (
    '8ff44453739054348a9b66c5103aade9c4930218' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/mp/avita.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce6d3b9c9f862_32235415 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>Avita<small>アビータ</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/mp/mp_main_avita.png" alt="Avita" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											多くのマッサージパーラーが存在するペップリー通りとエカマイ通りに「アビータ」があります。
											料金も1500バーツ～とリーズナブルな料金で遊べるのは嬉しい限り！
											女の子の好みは正直意見の分かれるところだが料金の割に設備はキレイですよ♪
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
											...
											<div class="tableBox">
												<table>
													<tbody>
														...
														<tr>
															<th>住所</th><td>2455 New Phetchaburi Rd, Bangkapi, Huaykwang, Bangkok</td>
														</tr>
														<tr>
															<th>連絡先</th><td>02-319-7070</td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td class="menuBox">
																<dl>
																	<dt>クラス</dt>
																	<dd>
																		3 digit no(120分)：1500バーツ<br>
																		Ｍクラス(120分)：1800バーツ<br>
																		Ｓクラス(120分)：2300バーツ
																	</dd>
																</dl>
															</td>
