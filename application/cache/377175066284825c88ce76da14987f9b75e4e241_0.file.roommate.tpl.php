<?php
/* Smarty version 3.1.29, created on 2019-05-22 22:22:37
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/karaoke/roommate.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce54d1dd87732_82830966',
  'file_dependency' => 
  array (
    '377175066284825c88ce76da14987f9b75e4e241' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/karaoke/roommate.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce54d1dd87732_82830966 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/karaoke/karaoke_main_trendy.png" alt="Roommate"></div>
												<div class="bg"><h2>Roommate<small>ルームメイト</small></h2></div>
											</div>
											<section>
												<h3>設備／こだわり情報</h3>
												<div class="subBox">
...
img/shop/shop_icon_2play_off.png" alt="２回戦">
																...
																<tr>
																	<th>その他</th><td>日本語・英語：出来る女の子とできない女の子がいます<br>店外デート：ペイバー700バーツ</td>
																</tr>
															</tbody>
														</table>
													</div>
												...
												<div class="subBox">
													<div class="tableBox">
														<table>
															<tbody>
																<tr>
																	<th>店舗名</th><td>ルームメイト（Roommate）</td>
																</tr>
																<tr>
																	<th>地域</th><td>タニヤ</td>
																</tr>
																...
																<tr>
																	<th>住所</th><td>62/9 5th Fl,. Thaniya Rd, Suriwong, Bangkok 10500</td>
																</tr>
																<tr>
																	<th>連絡先</th><td>02-233-9696</td>
																</tr>
																<tr>
																	<th>営業時間</th><td>19:00～25:00</td>
																</tr>
																<tr>
																	<th>定休日</th><td>禁酒日（仏教の日、王室関係の日、選挙の日など）、タイ旧正月（4/13-15）</td>
																</tr>
																<tr>
																	<th>アクセス</th><td>BTS エカマエ駅 徒歩5分</td>
																</tr>
																<tr>
																	<th>取扱いカード</th>
																	<td>
																...
																<tr>
																	...
																	<td class="menuBox">
																		<dl>
																			<dt>ドリンク</dt>
																			<dd>
																				飲み放題コース一時間：600バーツ<br>
																				〈ボトルキープの場合〉<br>
																				テーブルチャージ：200バーツ<br>
																				レディースドリンク：200バーツ<br>
																				初めの1時間：600バーツ<br>
																				その後30分につき：200バーツ<br>
																				フルーツ＆スナックセット：200バーツ(人数によって異なります)
																			</dd>
																		</dl>
																		<dl>
																			<dt>ボトル</dt>
																			<dd>
																				ジョニーウォーカー(ブラックラベル)：1,800バーツ
																				シーバスリーガル：1,800バーツ
																				いいちこ：1,800バーツ
																				Hennessy V.S.O.P：2,500バーツ
																				Hennessy X.O：3,500バーツ
																			</dd>
																		</dl>
																	</td>
																</tr>
