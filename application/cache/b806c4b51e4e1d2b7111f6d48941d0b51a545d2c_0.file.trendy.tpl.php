<?php
/* Smarty version 3.1.29, created on 2019-05-22 02:03:30
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/karaoke/trendy.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce42f62671f67_17573843',
  'file_dependency' => 
  array (
    'b806c4b51e4e1d2b7111f6d48941d0b51a545d2c' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/karaoke/trendy.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce42f62671f67_17573843 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
search/karaoke/">カラオケ検索</a></li>
		<li>お店情報（Trendy Club）</li>
	</ul>
</nav>
<div id="contents"><!-- CONTENTS -->
<div class="mc">
	<article class="page">
		<h1>お店情報（Trendy Club）</h1>
		<div class="mcBox mcb">
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>Trendy Club<small>トレンディークラブ</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/karaoke/karaoke_main_trendy.png" alt="Trendy Club" width="650" height="300"></div>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										<div class="subBox">
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>トレンディークラブ（Trendy Club）</td>
														</tr>
														<tr>
															<th>地域</th><td>タニヤ</td>
														</tr>
														...
														<tr>
															<th>住所</th><td>62/9-10 6Fl, Soi Thaniya, Silom Road, Suriyawongse, Bangkok 10500</td>
														</tr>
														<tr>
															<th>連絡先</th><td>02-632-6998</td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td class="menuBox">
																<dl>
																	<dt>ドリンク</dt>
																	<dd>
																	ウイスキー（シーバス/ブラックレーベル）：2,000バーツ<br>
																	いいちこ：2,000バーツ<br>
																	テキーラ：1,650バーツ<br>
																	ビール（シンガー/ハイネケン）：150バーツ<br>
																	ソフトドリンク（コーラ/ソーダ/水/氷）：50バーツ<br>
																	レディードリンク（60分）：180バーツ
																	</dd>
																</dl>
															</td>
