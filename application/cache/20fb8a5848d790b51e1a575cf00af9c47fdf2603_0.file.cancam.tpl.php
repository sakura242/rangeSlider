<?php
/* Smarty version 3.1.29, created on 2019-05-22 18:28:03
  from "/home/dev0006/www/thai-lover/production/application/views/sp/shop/massage/cancam.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce51623bc2d55_48668223',
  'file_dependency' => 
  array (
    '20fb8a5848d790b51e1a575cf00af9c47fdf2603' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/sp/shop/massage/cancam.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce51623bc2d55_48668223 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
img/search/massage/massage_main_cancam.png" alt="キャンキャン"></div>
												<div class="bg"><h2>CanCam<small>キャンキャン</small></h2></div>
											</div>
											<div class="inBox font">
												<p>
													日本人好みの女の子が多いので、日本人に人気のあるお店です。
													また、日本人の喜ぶツボを心得ている子が多く、マッサージのサービスも満点♪
												</p>
											</div>
											<section>
												<h3>設備／こだわり情報</h3>
													...
													<div class="tableBox">
														<table>
															<tbody>
																...
																<tr>
																	<th>住所</th><td>6/2 Soi26/1 Sukhumvit RD,Klongtoey,Bangkok 10110</td>
																</tr>
																<tr>
																	<th>連絡先</th><td>02-665-6161<br>日本人スタッフが対応します。</td>
																</tr>
																<tr>
																...
																<tr>
																	<th>メニュー</th>
																	<td>
																		セクシーシャワー(60分)　2,200バーツ<br>
																		セクシーシャワー(70分)　2,500バーツ<br>
																		セクシーシャワー(90分)　2,800バーツ<br>
																		エロティックジャグジー(60分)　2,700バーツ<br>
																		エロティックジャグジー(70分)　3,000バーツ<br>
																		エロティックジャグジー(90分)　3,300バーツ<br>
																		ヌルヌルマット(60分)　3,000バーツ<br>
																		ヌルヌルマット(70分)　3,300バーツ<br>
																		ヌルヌルマット(90分)　3,600バーツ
																	</td>
																</tr>
															</tbody>
														</table>
...
img/shop/girl/girl_img57.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img58.jpg" alt="" class="img-width-100"></li>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img59.jpg" alt="" class="img-width-100"></li>
													</ul>
													<ul>
														<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img60.jpg" alt="" class="img-width-100"></li>
													</ul>
												</div>
											</div>
										</section>
									...
									<div class="content">
										<section>
											...
											<div class="subBox">
												<div class="mapBorder">
													<div id="maps">
														<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d31006.56623119342!2d100.57074900000002!3d13.729298!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDQzJzQ1LjUiTiAxMDDCsDM0JzE0LjciRQ!5e0!3m2!1sen!2sus!4v1433125118816" width="90%" height="300" frameborder="0" style="border:0"></iframe>
													</div>
												</div>
											</div>
										</section>
