<?php
/* Smarty version 3.1.29, created on 2019-05-22 16:01:54
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/mp/angelina.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce4f3e22841f9_48736074',
  'file_dependency' => 
  array (
    '9925570bfed8f73b0cecc3b4ae20847612df9d11' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/mp/angelina.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce4f3e22841f9_48736074 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>Angelina<small>アンジェリーナ</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/mp/mp_main_angelina.png" alt="アンジェリーナ" width="650" height="300"></div>
									</div>
									<div class="subBox">
										<p>
											Colonze２からOceanに店名を変更しリニューアル！建物の1階にタマダー（通常）の女の子が、２階にモデルクラスの女の子がいます。
											日本人に人気のマッサージパーラー「ナタリー」からも歩いていける距離なので、あわせて回るのがGood！。
											建物はとても派手でアミューズメント施設のようになっているので楽しめますよ！
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
										...
										<div class="subBox">
											<div class="tableBox">
												<table>
													<tbody>
														<tr>
															<th>店舗名</th><td>アンジェリーナ（Angelina）</td>
														</tr>
														<tr>
														...
														<tr>
															<th>住所</th><td>2351 New Petchaburi Rd, Bangkapi, Hauykwang, Bangkok 10310</td>
														</tr>
														<tr>
															<th>連絡先</th><td>02-318-1673</td>
														</tr>
														<tr>
															<th>営業時間</th><td>13:00 ～ 0:00</td>
														</tr>
														<tr>
															<th>定休日</th><td>－</td>
														</tr>
														...
														<tr>
															...
															<td class="menuBox">
																<dl>
																	<dt>クラス</dt>
																	<dd>
																		2 digit no(120分)：1200バーツ<br>
																		3 digit no(120分)：1400バーツ<br>
																		Ｓクラス(90分)：1900バーツ
																	</dd>
																</dl>
															</td>
