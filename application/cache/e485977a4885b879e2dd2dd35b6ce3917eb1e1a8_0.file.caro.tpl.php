<?php
/* Smarty version 3.1.29, created on 2019-05-21 23:45:01
  from "/home/dev0006/www/thai-lover/production/application/views/pc/shop/karaoke/caro.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5ce40eed808087_06789716',
  'file_dependency' => 
  array (
    'e485977a4885b879e2dd2dd35b6ce3917eb1e1a8' => 
    array (
      0 => '/home/dev0006/www/thai-lover/production/application/views/pc/shop/karaoke/caro.tpl',
      1 => 1558344464,
      2 => 'file',
    ),
  ),
...
function content_5ce40eed808087_06789716 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
<head>
					...
					<!-- 基本情報 -->
						<div class="area" id="navinfo">
							<div class="content">
								<section>
									<div class="topImage">
										<div class="bg"><h2>CARO<small>カーロ</small></h2></div>
										<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/search/karaoke/karaoke_main_caro.png" alt="CARO" width="650" height="300"></div>
									</div>
									<div class="subBox">一緒に美味しいお酒を楽しむ事が出来ます！
										<p>
											「CARO」ですが、ノリの良い女の子たちがバニーガールの衣装に身を包んでワイワイ楽しく一緒にお酒を飲んでくれます。
											料金もリーズナブルなのでお手頃に楽しみたい人にもオススメ！カラオケは最新のDAMを導入しているので、飲むだけでなく歌いながら楽しみたい方にはたまらないお店です！！
										</p>
									</div>
									<section>
										<h3>設備／こだわり情報</h3>
											...
											<div class="tableBox">
												<table>
													<tbody>
														...
														<tr>
															<th>住所</th><td>3Floor 44/5-6 Soi Akkhara Phat Alley Thonglor soi 13,Bangkok</td>
														</tr>
														<tr>
															<th>連絡先</th><td>080-599-2827（日本語可能）</td>
														</tr>
														<tr>
														...
														<tr>
															<th>アクセス</th><td>BTSトンロー駅より徒歩約15分</td>
														</tr>
														<tr>
															<th>取扱いカード</th>
															<td>
...
img/shop/credit_jcb.png" alt="JCB" width="39" height="27">
														...
														<tr>
															<th>VIPルーム</th><td>2部屋*部屋代金が60分300バーツかかります。</td>
														</tr>
														<tr>
															<th>セット料金</th>
															<td>
																60分1,200バーツ（ウイスキー・焼酎・ビール飲み放題）<br>
																※スナック又はフルーツ付き
															</td>
														</tr>
														<tr>
															...
															<td class="menuBox">
																<dl>
																	<dt>ドリンク</dt>
																	<dd>
																		ウイスキー（シーバス/ブラックレーベル）：3,000バーツ<br>
																		焼酎（いいちこ）：2,200バーツ<br>
																		シャンパン：1,500バーツ<br>
																		ワイン（白/赤）：1,500バーツ<br>
																		ビール（ASAHI）：150バーツ（350ml）<br>
...
img/shop/girl/girl_img215.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img216.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img217.jpg" alt="" width="150" height="200"></li>
												<li><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
img/shop/girl/girl_img218.jpg" alt="" width="150" height="200"></li>
											</ul>
										</div>
									</div>
								</section>
